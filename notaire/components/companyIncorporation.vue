<script setup>
  ...
  const documentToSupply = [
    {text: "CNI des associés", status: "", inputName: "cni"},
    {text: "Casier judiciaire", status: "", inputName: "casierjudiciaire"},
    {text: "Bail", status: "", inputName: "bail"},
    {text: "Croquis de la situation géographique du lieu", status: "", inputName: "croquis"},
    {text: "Fiche à renseigner de la société à constituer", status: "", inputName: "fiche"},
    {text: "Capital à libérer", status: "", inputName: "capital"}
  ];
...
<template>
  <div class="perso">
    ...
    <step-box 
      ...
      icon="policy.png" 
      date="17/01/2025" 
      :listOfSubStep="[{text: 'Rédaction des status', status: '', inputName: 'redaction'}]" 
    />
    <step-box 
      :number="3" 
    ...
    <step-box 
      ...
      icon="document.png" 
      date="17/01/2025" 
      :listOfSubStep="[{text: 'Dépôt au CEPICI des actes signés', status: '', inputName: 'depot'}]" 
    />
    <step-box 
      :number="6" 
      title="Livrables" 
