<template>
    <div class="ma-4" >
        <back-button title="Procédure de succession de biens immobiliers" goBackTo="/addProcedure"/>
    </div>
                ...
                >
                    ...
                    <v-row>
                        ...
                        >
                            ...
                            <required-document label="CNI des ayants droit" v-model:file="cniOfRightsHolders"></required-document>
                        </v-col>
                        <v-col
                            cols="12"
                        >
                            
                            <required-document label="CNI du donateur" v-model:file="cniOfTheDonor"></required-document>
                        </v-col>
                        <v-col
                            cols="12"
                        >
                            
                            <required-document label="Extrait d'acte de naissance des ayants droits" v-model:file="birthCertificateOfTheRightsHolders"></required-document>
                        </v-col>
...
<script setup>
    ...
    const resetFields = () => {
        ...
        cniOfRightsHolders.value = null;
        cniOfTheDonor.value = null;
        birthCertificateOfTheRightsHolders.value = null;
    };
