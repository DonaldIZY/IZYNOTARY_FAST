...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const handleProcedure = async () => {
      ...
      const requiredFiles = {
        cniOfRightsHolders: cniOfRightsHolders.value,
        cniOfTheDonor: cniOfTheDonor.value,
        birthCertificateOfTheRightsHolders: birthCertificateOfTheRightsHolders.value
      };
      ...
      try {
        const date = await $fetch(
          `${testUrl}/folders/transferOfRealEstate`,
          {
            method: "POST",
            body: procedureData
          }
    ...
    return (_ctx, _push, _parent, _attrs) => {
                            ...
                            if (_push5) {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_required_document, {
                                      ...
                                      file: unref(cniOfRightsHolders),
                                      "onUpdate:file": ($event) => isRef(cniOfRightsHolders) ? cniOfRightsHolders.value = $event : null
                                    }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_required_document, {
                                      ...
                                      file: unref(cniOfTheDonor),
                                      "onUpdate:file": ($event) => isRef(cniOfTheDonor) ? cniOfTheDonor.value = $event : null
                                    }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(_component_required_document, {
                              ...
                              _push5(ssrRenderComponent(VCol, { cols: "12" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_required_document, {
                                      label: "Extrait d'acte de naissance des ayants droits",
                                      file: unref(birthCertificateOfTheRightsHolders),
                                      "onUpdate:file": ($event) => isRef(birthCertificateOfTheRightsHolders) ? birthCertificateOfTheRightsHolders.value = $event : null
                                    }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(_component_required_document, {
      ...
      _push(ssrRenderComponent(_component_confirmation_modal, {
        text: "Voulez vous enregistrer la proc\xE9dure de succession de biens immobiliers ?",
        open: unref(openConf),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/transferOfRealEstate.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined;
};

export { _sfc_main as default };
//# sourceMappingURL=transferOfRealEstate-Dzook9gR.mjs.map
