import { computed, provide, onScopeDispose, toRef, createVNode, shallowRef, ref, mergeProps, withDirectives, Fragment, resolveDirective, vShow, watch, createTextVNode, inject, nextTick, toRaw, watchEffect, unref } from 'vue';
import { p as propsFactory, I as IconValue, ae as deepEqual, m as makeComponentProps, l as makeDensityProps, A as makeThemeProps, g as genericComponent, a4 as useProxiedModel, al as getUid, h as provideDefaults, j as useRender, R as Ripple, am as filterInputAttrs, V as VIcon, an as VLabel, aq as omit, ai as makeDisplayProps, f as makeTagProps, ar as makeGroupProps, a6 as useRtl, a7 as useDisplay, as as useGroup, a8 as useResizeObserver, at as useGoTo, au as VFadeTransition, B as makeVariantProps, C as provideTheme, aj as EventProp, q as makeBorderProps, t as makeElevationProps, aw as makeGroupItemProps, y as makeRoundedProps, z as makeRouterProps, Y as makeSizeProps, a5 as useLocale, D as useBorder, E as useVariant, F as useDensity, H as useElevation, M as useRounded, Z as useSize, ax as useGroupItem, N as useLink, P as genOverlays, ay as VExpandXTransition, o as VDefaultsProvider, az as defineComponent, X as MaybeTransition, aA as VExpandTransition, k as createSimpleFunctional, s as makeDimensionProps, G as useDimension, aB as deprecate, ao as useTextColor, W as convertToUnit, T as useBackgroundColor, U as getCurrentInstance, aF as useToggleScope, aG as makeVTextFieldProps, Q as makeTransitionProps$1, aH as VDialogTransition, af as wrapInArray, aI as useForm, aK as VTextField, aL as VMenu, aM as ensureValidVNode, aJ as forwardRefs, ap as matchesSelector, av as focusableChildren, ad as consoleError, ak as getPropertyFromItem, aC as focusChild, aE as debounce, ab as clamp, aD as isObject, aN as checkPrintable } from './server.mjs';
...
const VSelectionControl = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      }, [(_a2 = (_b = slots.input) == null ? undefined : _b.call(slots, {
        model,
        textColorClasses,
        textColorStyles,
        backgroundColorClasses,
        ...
        default: () => {
          ...
          return [genOverlays(isClickable.value || isActive.value, "v-list-item"), hasPrepend && createVNode("div", {
            ...
            default: () => {
              var _a3;
              var _a2;
              return [(_a3 = (_a2 = slots.title) == null ? undefined : _a2.call(slots, {
                title: props.title
            ...
            default: () => {
              var _a3;
              var _a2;
              return [(_a3 = (_a2 = slots.subtitle) == null ? undefined : _a2.call(slots, {
    ...
    useRender(() => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => {
          ...
          }, [(_a2 = (_a = slots.default) == null ? undefined : _a.call(slots)) != null ? _a2 : props.title])];
        }
      });
    });
    return {};
...
const VListChildren = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    return () => {
      var _a2;
      var _a, _b;
      return (_a2 = (_a = slots.default) == null ? undefined : _a.call(slots)) != null ? _a2 : (_b = props.items) == null ? undefined : _b.map((_ref2) => {
        var _a3, _b3;
        var _a22, _b2;
        let {
          children,
        ...
        if (type === "divider") {
          return (_a3 = (_a22 = slots.divider) == null ? undefined : _a22.call(slots, {
            props: itemProps
          })) != null ? _a3 : createVNode(VDivider, itemProps, null);
        }
        if (type === "subheader") {
          return (_b3 = (_b2 = slots.subheader) == null ? undefined : _b2.call(slots, {
            props: itemProps
        ...
        const slotsWithItem = {
          subtitle: slots.subtitle ? (slotProps) => {
            var _a32;
            return (_a32 = slots.subtitle) == null ? undefined : _a32.call(slots, {
              ...slotProps,
              item
            });
          } : undefined,
          prepend: slots.prepend ? (slotProps) => {
            var _a32;
            return (_a32 = slots.prepend) == null ? undefined : _a32.call(slots, {
              ...slotProps,
              item
            });
          } : undefined,
          append: slots.append ? (slotProps) => {
            var _a32;
            return (_a32 = slots.append) == null ? undefined : _a32.call(slots, {
              ...slotProps,
              item
            });
          } : undefined,
          title: slots.title ? (slotProps) => {
            var _a32;
            return (_a32 = slots.title) == null ? undefined : _a32.call(slots, {
              ...slotProps,
              item
            });
          } : undefined
...
const VSelect = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const menu = computed({
      ...
      set: (v) => {
        var _a;
        if (_menu.value && !v && ((_a = vMenuRef.value) == null ? undefined : _a.\u03A8openChildren.size)) return;
        _menu.value = v;
      }
    });
    const {
    ...
    function onAfterEnter() {
      var _a;
      if (props.eager) {
        (_a = vVirtualScrollRef.value) == null ? undefined : _a.calculateVisibleItems();
      }
    }
...
export { VSelect as V, VDivider as a, VSlideGroup as b, VChip as c, VCheckboxBtn as d, makeFilterProps as e, makeSelectProps as f, useItems as g, useScrolling as h, VList as i, VListItem as j, VVirtualScroll as k, makeVSlideGroupProps as m, transformItem$1 as t, useFilter as u };
//# sourceMappingURL=filter-BGBihEE2.mjs.map
