import { hasInjectionContext, inject as inject$1, version as version$1, unref, watch, onScopeDispose, isVNode, Comment, Fragment, warn, getCurrentInstance as getCurrentInstance$1, ref, computed, provide, defineComponent as defineComponent$1, capitalize, camelize, h, toRaw, createVNode, mergeProps, readonly, shallowRef, reactive, isRef, toRef, toRefs, Text, watchEffect, Transition, resolveDynamicComponent, withDirectives, createTextVNode, Teleport, vShow, resolveDirective, markRaw, cloneVNode, defineAsyncComponent, shallowReactive, Suspense, effectScope, nextTick, TransitionGroup, useSSRContext, createApp, getCurrentScope, onErrorCaptured, onServerPrefetch, isReadonly, withCtx, isShallow, isReactive } from 'vue';
import { $ as $fetch, k as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, e as createError$1, n as sanitizeStatusCode, o as getContext, p as createHooks, q as toRouteMatcher, r as createRouter$1, v as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "addProcedure",
    path: "/addProcedure",
    component: () => import('./addProcedure-DFiEkmFD.mjs')
  },
  {
    name: "administration",
    path: "/administration",
    component: () => import('./administration-DO-eUUmm.mjs'),
    children: [
      {
        name: "administration-permissions",
        path: "permissions",
        component: () => import('./permissions-C6qGbdWl.mjs')
      },
      {
        name: "administration-roles",
        path: "roles",
        component: () => import('./roles-Y7NZyMQR.mjs')
      },
      {
        name: "administration-users",
        path: "users",
        component: () => import('./users-CCKToRao.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./companyFormation-DYwwwXvJ.mjs')
  },
  {
    name: "companyIncorporationDetails",
    path: "/companyIncorporationDetails",
    component: () => import('./companyIncorporationDetails-BKVksEGl.mjs')
  },
  {
    name: "companyModificationDetails",
    path: "/companyModificationDetails",
    component: () => import('./companyModificationDetails-BGJxt9XI.mjs')
  },
  {
    name: "customersManagement-ID",
    path: "/customersManagement/:ID()",
    component: () => import('./_ID_-tcZ6B0L1.mjs')
  },
  {
    name: "customersManagement",
    path: "/customersManagement",
    component: () => import('./index-BQ0gWtUJ.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-CVWHnfVA.mjs')
  },
  {
    name: "home",
    path: "/home",
    component: () => import('./home-Y5JD6r2m.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$1,
    component: () => import('./index-DpLkjVQ4.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta,
    component: () => import('./login-DsJJymDB.mjs')
  },
  {
    name: "modificationCompany",
    path: "/modificationCompany",
    component: () => import('./modificationCompany-BMBtCA2K.mjs')
  },
  {
    name: "personalPropertyDetails",
    path: "/personalPropertyDetails",
    component: () => import('./personalPropertyDetails-Hd2LdfKG.mjs')
  },
  {
    name: "proceduresManagement",
    path: "/proceduresManagement",
    component: () => import('./proceduresManagement-C7UjpLnc.mjs')
  },
  {
    name: "realEstateDetails",
    path: "/realEstateDetails",
    component: () => import('./realEstateDetails-CN3gqi5K.mjs')
  },
  {
    name: "salesDetails",
    path: "/salesDetails",
    component: () => import('./salesDetails-T5uM5nxB.mjs')
  },
  {
    name: "selling",
    path: "/selling",
    component: () => import('./selling-BRVUOvxR.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import('./settings-pEAkP1BK.mjs')
  },
  {
    name: "transferOfMovableProperty",
    path: "/transferOfMovableProperty",
    component: () => import('./transferOfMovableProperty-BZEcHHpk.mjs')
  },
  {
    name: "transferOfRealEstate",
    path: "/transferOfRealEstate",
    component: () => import('./transferOfRealEstate-Dzook9gR.mjs')
  }
];
...
function parseThemeOptions() {
  ...
  for (const [key, theme] of Object.entries(options.themes ?? {})) {
    const defaultTheme2 = theme.dark || key === "dark" ? (_a = defaults.themes) == null ? undefined : _a.dark : (_b = defaults.themes) == null ? undefined : _b.light;
...
const vuetify_7h9QAQEssH = /* @__PURE__ */ defineNuxtPlugin((app) => {
  const vuetify = createVuetify({
    ...
    locale: {
      ...
      messages: { fr }
      // Importer les messages en français
    }
  });
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DT1NW_Vi.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-BcRSOwvc.mjs'));
...
export { useRoute$1 as $, makeThemeProps as A, makeVariantProps as B, provideTheme as C, useBorder as D, useVariant as E, useDensity as F, useDimension as G, useElevation as H, IconValue as I, useLoader as J, useLocation as K, usePosition as L, useRounded as M, useLink as N, LoaderSlot as O, genOverlays as P, makeTransitionProps$1 as Q, Ripple as R, Intersect as S, useBackgroundColor as T, getCurrentInstance as U, VIcon as V, convertToUnit as W, MaybeTransition as X, makeSizeProps as Y, useSize as Z, _export_sfc as _, navigateTo as a, makeVFieldProps as a$, VBtnToggle as a0, VBtn as a1, __nuxt_component_0 as a2, isOn as a3, useProxiedModel as a4, useLocale as a5, useRtl as a6, useDisplay as a7, useResizeObserver as a8, createRange as a9, VExpandTransition as aA, deprecate as aB, focusChild as aC, isObject as aD, debounce as aE, useToggleScope as aF, makeVTextFieldProps as aG, VDialogTransition as aH, useForm as aI, forwardRefs as aJ, VTextField as aK, VMenu as aL, ensureValidVNode as aM, checkPrintable as aN, asyncDataDefaults as aO, createError as aP, fetchDefaults as aQ, VSpacer as aR, makeVOverlayProps as aS, useScopeId as aT, VOverlay as aU, VSheet as aV, noop as aW, isComposingIgnoreKey as aX, makeFormProps as aY, createForm as aZ, makeVInputProps as a_, keyValues as aa, clamp as ab, defineFunctionalComponent as ac, consoleError as ad, deepEqual as ae, wrapInArray as af, getObjectValueByPath as ag, isEmpty as ah, makeDisplayProps as ai, EventProp as aj, getPropertyFromItem as ak, getUid as al, filterInputAttrs as am, VLabel as an, useTextColor as ao, matchesSelector as ap, omit as aq, makeGroupProps as ar, useGroup as as, useGoTo as at, VFadeTransition as au, focusableChildren as av, makeGroupItemProps as aw, useGroupItem as ax, VExpandXTransition as ay, defineComponent as az, useNuxtApp as b, useFocus as b0, humanReadableFileSize as b1, VInput as b2, filterFieldProps as b3, VField as b4, VCounter as b5, callEvent as b6, makeVBtnProps as b7, animate as b8, standardEasing as b9, keys as ba, makeLazyProps as bb, useLazy as bc, makeLayoutItemProps as bd, useLayoutItem as be, makeLayoutProps as bf, createLayout as bg, useLayout as bh, useRuntimeConfig as c, resolveUnrefHeadInput as d, entry$1 as default, breakpoints as e, makeTagProps as f, genericComponent as g, provideDefaults as h, injectHead as i, useRender as j, createSimpleFunctional as k, makeDensityProps as l, makeComponentProps as m, nuxtLinkDefaults as n, VDefaultsProvider as o, propsFactory as p, makeBorderProps as q, resolveRouteObject as r, makeDimensionProps as s, makeElevationProps as t, useRouter$1 as u, makeLoaderProps as v, makeLocationProps as w, makePositionProps as x, makeRoundedProps as y, makeRouterProps as z };
